...
public class PlaylistService {
	 ...
	 *             the common exception
	 */
	public void removePlaylist(Long id) throws CommonException {
	 ...
	 * @return the playlist
	 */
	public Playlist findRecord(Long id) {
	 ...
	 */
	public Playlist insert(String playlistId) throws CommonException {
		if (playlistId != null) {
