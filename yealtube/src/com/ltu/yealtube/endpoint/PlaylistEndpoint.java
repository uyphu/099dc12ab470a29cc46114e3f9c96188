...
public class PlaylistEndpoint {
	...
	public void removePlaylist(@Named("id") String id) throws CommonException {
		PlaylistService service = PlaylistService.getInstance();
	...
	public Playlist getPlaylist(@Named("id") String id) {
	 ...
	 */
	private Playlist findRecord(String id) {
		PlaylistService service = PlaylistService.getInstance();
